    ...
    <footer className="w-full border-t border-slate-200 bg-slate-50 px-6 py-16">
      <div className="grid grid-cols-1 lg:grid-cols-12 max-w-7xl mx-auto gap-8 md:gap-12 lg:gap-16">
        ...
        <div className="lg:col-span-4 flex flex-col">
          ...
          <div className="flex gap-3">
             <a 
               ...
               className="w-10 h-10 bg-white border border-slate-200 rounded-xl flex items-center justify-center text-slate-500 hover:text-[#0077b5] hover:border-[#0077b5]/30 shadow-sm transition-all"
               aria-label="LinkedIn"
             >
             ...
             <a 
               ...
               target="_blank" 
               rel="noopener noreferrer" 
               className="w-10 h-10 bg-white border border-slate-200 rounded-xl flex items-center justify-center text-slate-500 hover:text-[#e4405f] hover:border-[#e4405f]/30 shadow-sm transition-all"
             ...
             <a 
               ...
               target="_blank" 
               rel="noopener noreferrer" 
               className="w-10 h-10 bg-white border border-slate-200 rounded-xl flex items-center justify-center text-slate-500 hover:text-[#1da1f2] hover:border-[#1da1f2]/30 shadow-sm transition-all"
        ...
        <div className="lg:col-span-8 w-full">
          <div className="grid grid-cols-2 md:grid-cols-4 w-full gap-8 mb-12">
            <div>
              <h3 className="font-bold text-slate-900 mb-4 text-sm uppercase tracking-wider">Agência</h3>
            ...
            <div>
              <h3 className="font-bold text-slate-900 mb-4 text-sm uppercase tracking-wider">Soluções</h3>
              <ul className="space-y-3">
            ...
            <div>
              <h3 className="font-bold text-slate-900 mb-4 text-sm uppercase tracking-wider">Sistema</h3>
              <ul className="space-y-3">
      ...
      <div className="max-w-7xl mx-auto border-t border-slate-200 flex flex-col md:flex-row justify-between items-center mt-12 md:mt-16 pt-8 gap-4">
        ...
        <p className="text-[10px] text-slate-500 uppercase tracking-widest font-bold">
          Feito com <span className="text-brand-750">foco</span> em resultados Reais
        </p>
      </div>
    </footer>
  );
