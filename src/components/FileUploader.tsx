...
export function FileUploader({ currentUrl, onUploadSuccess, folder, accept = "image/webp,image/png,image/jpeg,image/svg+xml,application/pdf" }: FileUploaderProps) {
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file.type.startsWith('image/') && !['image/webp', 'image/png', 'image/jpeg', 'image/svg+xml'].includes(file.type)) {
      setError('Formato de imagem não suportado. Use WEBP, PNG ou JPG.');
      return;
    }
